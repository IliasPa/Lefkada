...
export type TabKey = 'home' | 'culture' | 'health' | 'financials' | 'governance' | 'about' | 'services' | 'education' | 'jobs' | 'contacts' | 'account';
...
export const HIDEABLE_TABS: TabKey[] = [
  'home', 'culture', 'health', 'financials', 'governance', 'about', 'services', 'education', 'jobs', 'contacts',
];
...
export function AppProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    if (tabParam && ['home', 'culture', 'health', 'financials', 'governance', 'about', 'services', 'education', 'jobs', 'contacts', 'account'].includes(tabParam)) {
